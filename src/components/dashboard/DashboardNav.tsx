...
export default function DashboardNav({
  ...
  return (
    <nav className="sticky top-20 z-30 mb-6 rounded-2xl border border-gray-200 bg-white/90 p-1 shadow-sm backdrop-blur transition-colors dark:border-slate-800 dark:bg-slate-900/80">
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-sm font-semibold transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                isActive
                  ...
                  : "text-gray-600 hover:bg-gray-50 dark:text-slate-300 dark:hover:bg-slate-800/80"
              }`}
            >
              <span>{label}</span>
            </button>
